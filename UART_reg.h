...
#define UART1_DMAControl_Reg       ((volatile UARTDMACTL*)(UART0_BASE+UARTDMACTL_OFFSET))
#define UART2_DMAControl_Reg       ((volatile UARTDMACTL*)(UART0_BASE+UARTDMACTL_OFFSET))
#define UART3_DMAControl_Reg       ((volatile UARTDMACTL*)(UART0_BASE+UARTDMACTL_OFFSET))
#define UART4_DMAControl_Reg       ((volatile UARTDMACTL*)(UART0_BASE+UARTDMACTL_OFFSET))
#define UART5_DMAControl_Reg       ((volatile UARTDMACTL*)(UART0_BASE+UARTDMACTL_OFFSET))
#define UART6_DMAControl_Reg       ((volatile UARTDMACTL*)(UART0_BASE+UARTDMACTL_OFFSET))
#define UART7_DMAControl_Reg       ((volatile UARTDMACTL*)(UART0_BASE+UARTDMACTL_OFFSET))
